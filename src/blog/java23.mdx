...
excerpt: "제네릭은 자바 5 이후에 도입되었다. 제네릭(Generic)은 클래스 내부에서 사용할 데이터 타입을 외부에서 지정하는 기법을 의미한다. 먼저 예제를 보자."
date: "2019-09-05"
cover: "java/java-23-cover.jpeg"
thumbnail: "java/java-23-thumbnail.jpeg"
category: "java"
---
