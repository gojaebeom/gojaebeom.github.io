...
excerpt: "상위 클래스에 정의된 메소드를 하위 클래스에서 다시 정의하는 행위를 가리켜 '메소드 오버라이딩' 이라 하는데, 여기서 말하는 오버라이딩은 '무효화 시키다'의 뜻으로 해석이 된다."
date: "2019-08-19"
cover: "java/java-17-cover.jpeg"
thumbnail: "java/java-17-thumbnail.jpeg"
category: "java"
---
