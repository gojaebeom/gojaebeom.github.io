...
slug: "java19"
title: "JAVA - 19. 인터페이스"
excerpt: "위의 예제는 인터페이스 선언의 모습이다. 기본 골격은 클래스와 동일하다. 그러나 class 대신 interface라는 키워드를 사용하고, 내부에 있는 메소드는 몸체 없이 세미콜론으로 마무리 된다. 위와 같이 몸체가 비어있는 메소드를 가리켜 **추상 메소드(Abstract Methods)** 라 한다."
date: "2019-08-26"
cover: "java/java-19-cover.jpeg"
thumbnail: "java/java-19-thumbnail.jpeg"
category: "java"
---
