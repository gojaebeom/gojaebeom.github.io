...
slug: "servlet06"
title: "jsp 프로그래밍"
excerpt: "jsp란 `Java Server Pages` 의 약자이며 HTML 코드에 JAVA 코드를 넣어 동적웹페이지를 생성하는 웹어플리케이션 도구이다."
date: "2019-09-25"
cover: "servlet/servlet-06-cover.jpeg"
thumbnail: "servlet/servlet-06-thumbnail.jpeg"
