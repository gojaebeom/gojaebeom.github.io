...
excerpt: "변수(Variable)란? 변수란 데이터의 저장과 참조를 위해 할당된 메모리 공간 에 붙인 이름을 말한다. 변하는 값을 프로그램에서 나타내는 방법"
date: "2019-05-02"
cover: "java/java-02-cover.jpg"
thumbnail: "java/java-02-thumbnail.jpg"
---
...
_자바에서 정수형은 주로 int가 많이 사용이되고 실수형은 double이 많이 사용된다._
