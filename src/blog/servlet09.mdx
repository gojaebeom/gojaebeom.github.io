---
slug: "servlet09"
title: "jsp 프로젝트 만들기 - DB연결"
excerpt: "JDBC는 자바에서 데이터베이스에 접속할 수 있도록 하는 자바 API이다. JDBC는 데이터베이스에서 자료를 쿼리하거나 업데이트하는 방법을 제공한다."
date: "2019-09-30"
cover: "servlet/servlet-09-cover.jpeg"
thumbnail: "servlet/servlet-09-thumbnail.jpeg"
