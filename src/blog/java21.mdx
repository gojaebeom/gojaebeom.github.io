...
excerpt: "객체지향은 프로그램 설계방법론중 하나 이다. 프로그램을 수많은 '객체'라는 기본 단위로 나누고 이 객체들의 상호작용으로 서술하는 방식이다. 객체란 하나의 역할을 수행하는 '메소드와 변수(데이터)'의 묶음으로 봐야 한다."
date: "2019-09-01"
cover: "java/java-21-cover.jpeg"
thumbnail: "java/java-21-thumbnail.jpeg"
category: "java"
---
